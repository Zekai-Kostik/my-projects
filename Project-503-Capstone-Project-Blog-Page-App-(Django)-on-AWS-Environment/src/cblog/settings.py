...
DATABASES = {
    'default': {
        ...
        'NAME': 'capstaone-database', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstaone-database.c7qrstfleywr.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-pr-s3' # please enter your s3 bucket name
